...
import { Query, Select, DeepFilterNever, IDsList, User, UserSort, UserFilter, AvailableUserSelection, Scalars, UpdateUserInput } from "../types.js";
...
/**
  ...
  */
declare function signOutUser<Options extends SignOutUserOptions>(id: string, options?: LimitToKnownKeys<Options, SignOutUserOptions>): Promise<SignOutUserResult<Options>>;
/**
 * The fully-qualified, expanded form of the inputs for executing this action.
 * The flattened style should be preferred over this style, but for models with ambiguous API identifiers, this style can be used to remove any ambiguity.
 **/
